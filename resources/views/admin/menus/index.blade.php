                    ...
                    <tr class="text-gray-700 hover:bg-gray-50/80 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            @php
                                ...
                                $catColor = match(true) {
                                    $cat == 'makanan' => 'bg-orange-100 text-orange-700 border-orange-200',
                                    $cat == 'minuman' => 'bg-blue-100 text-blue-700 border-blue-200',
                                    // PERUBAHAN DISINI: Support nama baru dan lama
                                    in_array($cat, ['makanan_sehat', 'paket_hemat', 'paket hemat']) => 'bg-emerald-100 text-emerald-700 border-emerald-200',
                                    $cat == 'snack' => 'bg-yellow-100 text-yellow-700 border-yellow-200',
                                    default => 'bg-gray-100 text-gray-700 border-gray-200'
                                };
                                
                                // Label Display
                                $label = ucfirst(str_replace('_', ' ', $menu->category));
                                if($cat == 'paket_hemat') $label = 'Makanan Sehat'; // Override display lama
                                if($cat == 'makanan_sehat') $label = 'Makanan Sehat';
                            @endphp
